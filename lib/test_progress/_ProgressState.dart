...
class MyProgress extends StatefulWidget {
  ...
  MyProgress({@required this.size, this.milliseconds: 300, this.color: Colors
      .green, this.count: 4});
...
class _ProgressState extends State<MyProgress> with TickerProviderStateMixin {
  ...
  void dispose() {
    ...
    for (AnimationController _animationCountroller in _animationControllers) {
      _animationCountroller.dispose();
    }
  }
}
